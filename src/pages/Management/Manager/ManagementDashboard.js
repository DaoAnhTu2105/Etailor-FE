...
export default function ManagementDashboard() {
  const OrderStatistic = ({ searchMonth, searchYear, lineChart, barChart }) => {
    ...
    useEffect(() => {
      ...
      const GET_ORDER_STATISTIC_BY_YEAR = `https://localhost:7259/api/Dashboard/order-dashboard-by-year?year=${searchYear}`;
          ...
          datasets: [
            {
              ...
              data: [
                ...
                revenueRateByYear[8],
                revenueRateByYear[9],
                revenueRateByYear[10],
                revenueRateByYear[11],
              ],
  ...
  const OverAllStatistic = () => {
    ...
    useEffect(() => {
      const fetchTaskCurrentMonthStatistic = async () => {
        setTaskLoading(true);
        const manager = JSON.parse(localStorage.getItem("manager"));
        const GET_TASK_CURRENT_MONTH_STATISTIC =
          "https://localhost:7259/api/task/manager/get-all";
        try {
    ...
    useEffect(() => {
      const manager = JSON.parse(localStorage.getItem("manager"));
      const baseOrderStatisticURL =
        "https://localhost:7259/api/Dashboard/order-dashboard";
      const fetchOrderStatistic = async () => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            const totalForStatus0 = data.find(
              (stat) => stat.status === 0
            )?.total;
            const totalForStatus7 = data.find(
              (stat) => stat.status === 8
            )?.total;
            ...
            const sumOfOtherStatuses = otherStatusTotals.reduce(
              (acc, curr) => acc + curr,
              0
            );
            const sumofAllOrders = data
              .map((stat) => stat.total)
      ...
      const fetchTotalOrderRate = async () => {
        ...
        const GET_TOTAL_ORDER_RATE = `https://localhost:7259/api/Dashboard/order-rate-dashboard?year=${searchYear}&month=${searchMonth}`;
        try {
      ...
      const fetchRevenueRate = async () => {
        ...
        const GET_REVENUE_RATE = `https://localhost:7259/api/Dashboard/order-price-rate-dashboard?year=${searchYear}&month=${searchMonth}`;
        try {
    ...
    return (
      <Row
        ...
        style={{ backgroundColor: "unset", margin: 15 }}
      >
        <Col span={12}>
          <Row>
                    ...
                    <>
                      ...
                      <p
                        style={{
                          fontSize: 24,
                          fontWeight: 600,
                          color: totalOrderRate.increase ? "green" : "red",
                          margin: 0,
                        }}
                      >
                        {totalOrderRate.increase ? (
                          <RiseOutlined />
                        ) : (
                          <FallOutlined />
                        )}{" "}
                  ...
                  <div style={{ textAlign: "center" }}>
                    {revenueLoading ? (
                      ...
                      <>
                        ...
                        >
                          {totalRevenue ? FormatVNCurrency(totalRevenue) : 0}
                        </p>
                        ...
                        <p
                          style={{
                            fontSize: 24,
                            fontWeight: 600,
                            color: totalRevenueRate.increase ? "green" : "red",
                            margin: 0,
                          }}
                        >
                          {totalRevenueRate.increase ? (
                            <RiseOutlined />
                          ) : (
                            <FallOutlined />
                          )}{" "}
                  ...
                  totalForOtherStatuses === 0 ? (
                    <>
                      <div style={{ width: "100%" }}>
                        ...
                        >
                          Không có dữ liệu đơn hàng tháng {searchMonth}{" "}
                        </p>
                      </div>
                    </>
                  ) : (
  ...
  const MaterialStatistic = ({ searchMonth, searchYear }) => {
    ...
    useEffect(() => {
      const fetchMaterialStatistic = async () => {
        ...
        const manager = JSON.parse(localStorage.getItem("manager"));
        const GET_MATERIAL_STATISTIC = `https://localhost:7259/api/Dashboard/fabric-material-common-used?year=${searchYear}&month=${searchMonth}`;
        try {
      ...
      const fetchCommonTemplate = async () => {
        ...
        const manager = JSON.parse(localStorage.getItem("manager"));
        const GET_COMMON_TEMPLATE = `https://localhost:7259/api/Dashboard/template-common-used?year=${searchYear}&month=${searchMonth}`;
        try {
    ...
    const templateData = {
      templateLabels:
        commonTemplate && commonTemplate.map((template) => template.name),
      datasets: [
        {
          label: "",
          data:
            commonTemplate && commonTemplate.map((template) => template?.total),
          borderColor: "rgb(53, 162, 235)",
          backgroundColor: "rgba(53, 162, 235, 0.5)",
        },
      ],
            ...
            <Row gutter={[16, 16]}>
              {commonTemplate ? (
                      ...
                      <Col xs={24} sm={12} md={12} lg={12} xl={12} key={index}>
                        ...
                        >
                          ...
                          <div style={{ marginLeft: 10 }}>
                            ...
                            >
                              Số đơn: {material.total ? material.total : 0}
                            </p>
                          </div>
                        </div>
                      </Col>
                ...
                >
                  ...
                  >
                    Không có dữ liệu hoặc chưa có đơn hàng
                  </p>
                </div>
              )}
            </Row>
                ...
                <>
                  <Col span={14}>
                    <div>
                      ...
                      >
                        Loại vải được ưa chuộng tháng {searchMonth}
                      </h1>
                    </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Top 3 loại vải được sử dụng nhiều nhất
                      </p>
                      {materialStatistic
                        .sort(
                          (a, b) =>
                            (b.totalProducts ? b.totalProducts : 0) -
                            (a.totalProducts ? a.totalProducts : 0)
                        )
                        .slice(0, 3)
                        .map((material, index) => (
                          <div
                ...
                <>
                  <Col span={14}>
                    <div>
                      ...
                      >
                        Bản mẫu được ưa chuộng tháng {searchMonth}
                      </h1>
                    </div>
                    <Bar
                      ...
                      data={{
                        labels:
                          commonTemplate &&
                          commonTemplate
                            .filter((template) => template.total > 0)
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        Top 3 bản mẫu được ưa chuộng nhất
                      </p>
                      {/* <p><FontAwesomeIcon icon={faRankingStar} /></p> */}
                      {commonTemplate
                        .sort(
                          (a, b) =>
                            (b.total ? b.total : 0) - (a.total ? a.total : 0)
                        )
                        .slice(0, 3)
                        .map((material, index) => (
                          <div
    ...
    >
      <div style={{ padding: "5px 20px" }}>
        <div style={{ paddingLeft: 20 }}>
          <h1 style={{ fontSize: 28, fontWeight: 600, color: "#3f4344" }}>
            Quản lý chung
          </h1>
        </div>
              ...
              options={[
                {
                  ...
                  label: "Tháng 1",
                  disabled:
                    searchYear === dayjs().year() && 1 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 2",
                  disabled:
                    searchYear === dayjs().year() && 2 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 3",
                  disabled:
                    searchYear === dayjs().year() && 3 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 4",
                  disabled:
                    searchYear === dayjs().year() && 4 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 5",
                  disabled:
                    searchYear === dayjs().year() && 5 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 6",
                  disabled:
                    searchYear === dayjs().year() && 6 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 7",
                  disabled:
                    searchYear === dayjs().year() && 7 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 8",
                  disabled:
                    searchYear === dayjs().year() && 8 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 9",
                  disabled:
                    searchYear === dayjs().year() && 9 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 10",
                  disabled:
                    searchYear === dayjs().year() && 10 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 11",
                  disabled:
                    searchYear === dayjs().year() && 11 > dayjs().month() + 1
                      ? true
                      : false,
                },
                {
                  ...
                  label: "Tháng 12",
                  disabled:
                    searchYear === dayjs().year() && 12 > dayjs().month() + 1
                      ? true
                      : false,
                },
              ]}
