...
export default function CustomerProfile() {
  ...
  useEffect(() => {
    const GET_USER_INFO_URL = `https://localhost:7259/api/customer-management/info`;
  ...
  const handleUpdatePersonalProfile = async () => {
    ...
    try {
      const UPDATE_PROFILE_URL =
        "https://localhost:7259/api/customer-management";
  ...
  return (
    <>
      <Toaster />
      <h2 className="title" style={{ textAlign: "center", fontSize: 26 }}>
        {" "}
        Thông tin tài khoản
      </h2>
      <div style={{ display: "grid", gridTemplateColumns: "60% 40%" }}>
        <div style={{ marginTop: "24px" }}>
          <div className="user-info">
            <div className="input-title">
              <h2 className="subtitle is-5">Họ và tên:</h2>
            </div>
          ...
          <div className="user-info">
            ...
            <div className="input-area">
              <h2 style={{ fontSize: "1.2rem", fontWeight: "400" }}>
                {FormatPhoneNumber(updateProfileData?.phone)}
              </h2>
              <p
                style={{
                  paddingLeft: "20px",
          ...
          <div className="user-info">
            <div className="input-title">
              <h2 className="subtitle is-5">Email:</h2>
            </div>
            <div className="input-area">
              <input
          ...
          <div className="user-info">
            <div className="input-title">
              <h2 className="subtitle is-5">Địa chỉ:</h2>
            </div>
            <div className="input-area">
              <input
        ...
        <div>
          <figure
            class="image preview-img-profile is-256x256"
          ...
          >
            <Button
              ...
              sx={{
                backgroundImage: `url(${
                  selectedImage || updateProfileData.avatar
                })`,
      ...
      <div className="save-btn">
        <div
          style={{ position: "absolute", bottom: "0", alignContent: "center" }}
        >
          <button
